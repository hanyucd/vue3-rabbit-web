<template>
  <div class="cart">
    <a class="curr" href="javascript:;">
      <i class="iconfont icon-cart"></i><em> {{ cartStore.effectiveListCounts }}</em>
    </a>

    <div class="layer">
      <div class="list">
        <!-- 🔔 cart.list 可能存在无效商品 -->
        <div v-for="item in cartStore.effectiveList" :key="item.skuId" class="item">
      ...
      <div class="foot">
        <div class="total">
          <p>共 {{ cartStore.effectiveListCounts }} 件商品</p>
          <p>&yen;{{ cartStore.effectiveListPrice }}</p>
        </div>
